<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <label for="ciudad" class="formulario__label">Nombre Evento</label>
        <input 
        type="text" 
    ...
    <div class="formulario__campo">
        ...
        <label for="ciudad" class="formulario__label">Descripción Evento</label>
        <textarea  
        class="formulario__input" 
        id="descripcion" 
        name="descripcion"
    ...
    <div class="formulario__campo">
        ...
        <label for="ciudad" class="formulario__label">Tipo de Evento</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <label for="ciudad" class="formulario__label">Ponente</label>
        <input 
        type="text" 
        class="formulario__input" 
        id="ponentes" 
    ...
    <div class="formulario__campo">
        ...
        <label for="ciudad" class="formulario__label">Lugares Disponibles</label>
        <input 
        type="text" 
        min = "1"
        class="formulario__input" 
